...
void NVIC_init_454(void)
{
    ...
    nvic_irq_enable(DMA1_Channel7_IRQn, 12, 0); // USART0_TX
    nvic_irq_enable(DMA1_Channel2_IRQn, 13, 0); // USART0_RX
    nvic_irq_enable(TIMER4_IRQn, 14, 0);        // PWM_IN
    nvic_irq_enable(DMA0_Channel6_IRQn, 15, 0);//USART1_TX
